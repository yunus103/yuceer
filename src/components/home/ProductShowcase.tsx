    ...
    <section className="py-20 bg-muted">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {items.map((product) => (
            <div key={product._id} className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                <Link href="/urunler">
                   <span className="text-sm font-medium text-gray-500 hover:text-primary flex items-center gap-1 mt-4">
                     Tümünü İncele <ArrowRight className="w-3 h-3" />
                   </span>
                </Link>
              </div>
            </div>
